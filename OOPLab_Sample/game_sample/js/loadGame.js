...
(function(){
    ...
    [
		...
		//level1
         // { src: 'game_sample/js/about.js', lookFor: 'About' },
		{ src: 'game_sample/js/GameMap.js', lookFor: 'GameMap' },
        
		{ src: 'game_sample/js/Textbox.js', lookFor: 'Textbox' },
		{ src: 'game_sample/js/Answer.js', lookFor: 'Answer' },
       
        { src: 'game_sample/js/myGameLevel1.js', lookFor: 'MyGame' },
         { src: 'game_sample/js/Background.js', lookFor: 'Background' },
        
		//level2
		/*{ src: 'game_sample/js/GameMap2.js', lookFor: 'GameMap' },
		{ src: 'game_sample/js/Textbox2.js', lookFor: 'Textbox' },
		{ src: 'game_sample/js/Answer2.js', lookFor: 'Answer' },
